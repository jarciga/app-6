...
if (strtoupper($_SERVER['REQUEST_METHOD']) === 'POST') {
    ...
    $temperaure = (isset($_POST['temperaure']) || !empty($_POST['temperaure'])) ? intval($_POST['temperaure']) : 0.0;
    $current = (isset($_POST['current']) || !empty($_POST['current'])) ? intval($_POST['current']) : 0.0;

    $var = new AdnuAcrms\Controllers\AlarmParamsController();
    echo $var->alarmParamsDataInput($name, $deviceId, $userId, $temperaure, $current);
}
else
{
